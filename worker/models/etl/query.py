...
class Query:
    ...
    def version(cls) -> str:
        """
        Return the simplified version of the query.
        Update this in child if the structure changes in a non-backward-compatible way.
        """
        raise NotImplementedError("Subclasses must implement version() method.")

    @classmethod
    def specific_version(cls) -> str:
        """
        Return the specific version of the query.
        This can be used for minor changes that are backward-compatible.
        """
        raise NotImplementedError(
            "Subclasses must implement specific_version() method."
        )
