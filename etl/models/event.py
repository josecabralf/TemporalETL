...
class Event:
    ...
    relation_properties: Optional[Dict[str, Any]] = (
        None  # jsonb, properties associated with the action
    )
    ...
    def relation_properties_as_json(self) -> Optional[str]:
        ...
        return (
            json.dumps(self.relation_properties, ensure_ascii=False)
    ...
    def event_properties_as_json(self) -> Optional[str]:
        ...
        return (
            json.dumps(self.event_properties, ensure_ascii=False)
